package com.byk.yygh.order.service.impl;
...
import com.byk.yygh.enums.OrderStatusEnum;
import com.byk.yygh.hosp.client.HospitalFeignClient;
import com.byk.yygh.model.order.OrderInfo;
import com.byk.yygh.model.user.Patient;
import com.byk.yygh.order.mapper.OrderMapper;
import com.byk.yygh.order.service.OrderService;
import com.byk.yygh.order.service.WeixinService;
import com.byk.yygh.user.client.PatientFeignClient;
import com.byk.yygh.vo.hosp.ScheduleOrderVo;
import com.byk.yygh.vo.msm.MsmVo;
import com.byk.yygh.vo.order.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderInfo> implements OrderService {
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        //调用医院接口实现预约取消
        System.out.println(orderInfo.getHoscode());
    ...
    public void patientTips() {
        ...
        wrapper.eq("order_statsus",OrderStatusEnum.CANCLE.getStatus());
