...
import com.byk.yygh.common.helper.JwtHelper;
...
import com.byk.yygh.user.utils.ConstantWxPropertiesUtil;
import com.byk.yygh.user.utils.HttpClientUtils;
    ...
    public String callback(String code,String state){
        ...
        try {
            ...
            if(userInfo == null){//数据库不存在微信信息
                //第三步 拿着openid和access_token请求微信地址，得到扫码人信息
